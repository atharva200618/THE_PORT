...
export const MODES = {
  ...
  utilities: {
    ...
    desc: 'Smart PDF Compressor (-75%), Multi-Photo to PDF Binder, and PDF reverse-engineering to Pages/Word.',
    placeholder: 'Drop photos/screenshots (.png, .jpg, .heic) or .pdf to compress...',
